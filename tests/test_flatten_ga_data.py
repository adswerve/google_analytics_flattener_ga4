...
class TestCFFlattenMethods(BaseUnitTest):
    ...
    def test_flatten_ga_data_check_output_flat_event_params(self):
        ...
        assert self.tbl_exists(client=self.client, dataset= self.ga_source.dataset, table_name = f"flat_event_params_{self.ga_source.date_shard}")
    ...
    def test_flatten_ga_data_check_output_flat_events(self):
        ...
        assert self.tbl_exists(client=self.client, dataset=self.ga_source.dataset,
    ...
    def test_flatten_ga_data_check_output_flat_user_properties(self):
        ...
        assert self.tbl_exists(client=self.client, dataset= self.ga_source.dataset, table_name = f"flat_user_properties_{self.ga_source.date_shard}")
